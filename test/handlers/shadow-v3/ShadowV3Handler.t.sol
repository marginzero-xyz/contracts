...
contract ShadowV3HandlerTest is Test {
    ...
    function testSplitPositionFirst() public {
        TestVars memory vars;
        ...
        // Define split ticks
        int24[] memory splitTicks = new int24[](5);
        ...
        splitTicks[3] = 200320;
        splitTicks[4] = initialTickUpper;

        console.log("Split ticks");
        console.log("Tick 0");
        console.logInt(splitTicks[0]);
        console.log("Tick 1");
        console.logInt(splitTicks[1]);
        console.log("Tick 2");
        console.logInt(splitTicks[2]);
        console.log("Tick 3");
        console.logInt(splitTicks[3]);
        console.log("Tick 4");
        console.logInt(splitTicks[4]);
        // Set initial amounts
        uint256 amount0Desired = 10000 * 10 ** 6; // 10,000 USDC
        uint256 amount1Desired = 5 * 10 ** 18; // 5 ETH
    ...
    function testSplitPositionZero() public {
        ...
        for (uint256 i = 0; i < splitTicks.length - 1; i++) {
            (uint256 liquidity,,,,) = pool.positions(
                keccak256(abi.encodePacked(address(handler), uint256(0), splitTicks[i], splitTicks[i + 1]))
            );
...

        {
            ...
            (liquidity,,,,) = pool.positions(
                keccak256(abi.encodePacked(address(handler), uint256(0), initialTickLower, initialTickUpper))
            );
            console.log(liquidity);
        }
    ...
    function testSplitPositionLessLiquidity() public {
        ...
        // Define split ticks
        int24[] memory splitTicks = new int24[](7);
        splitTicks[0] = initialTickLower;
        splitTicks[1] = initialTickLower + 20;
        splitTicks[2] = initialTickLower + (initialTickUpper - initialTickLower) / 4;
        splitTicks[3] = initialTickLower + (initialTickUpper - initialTickLower) / 2;
        splitTicks[4] = 200320;
        splitTicks[5] = splitTicks[4] + 20;
        splitTicks[6] = initialTickUpper;

        console.log("Initial tick lower");
        console.logInt(initialTickLower);
        console.log("Initial tick upper");
        console.logInt(initialTickUpper);
        ...
        console.log(ETH.balanceOf(owner));
    ...
    function testSplitPositionOneNegativeTick() public {
        ...
        shadowV3PoolUtils.addLiquidity(
            ShadowV3PoolUtils.AddLiquidityStruct({
                ...
                desiredAmount1: 100000000000000 ether,
                desiredTickLower: -887270,
                desiredTickUpper: 887270,
                requireMint: true
            })
        );
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = -((vars.currentTick / tickSpacing) * tickSpacing) - 10000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 150 * tickSpacing;

        // Step 2: Perform a small swap to generate more fees
        vm.startPrank(address(this));
        USDC.mint(address(this), 10000000000000000000000e6);
        USDC.approve(address(pool), 10000000000000000000000e6);

        pool.swap(
            address(this),
            true,
            int256(10000000000000000000000e6),
            TickMath.MIN_SQRT_RATIO + 1, // Swap to the upper tick
            abi.encode(address(this))
        );
        ...
        console.logInt(vars.currentTick);
    ...
    // Split position tests here

    function testSplitPositionWithPositiveTick_TickLower_Positive_TickUpper_Positive_InRange() public {
        TestVars memory vars;
    ...
    function testSplitPositionWithPositiveTick_TickLower_Positive_TickUpper_Positive_Token1() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 100 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) - 50 * tickSpacing;

        // Define split ticks
        int24[] memory splitTicks = new int24[](3);
        splitTicks[0] = initialTickLower;
        splitTicks[1] = initialTickLower + 20;
        splitTicks[2] = initialTickUpper;
    ...
    function testSplitPositionWithPositiveTick_TickLower_Positive_TickUpper_Positive_Token0() public {
        TestVars memory vars;
    ...
    function testSplitPositionWithPositiveTick_TickLower_Negative_TickUpper_Positive_InRange_1() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 100000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 100 * tickSpacing;

        // Define split ticks
        int24[] memory splitTicks = new int24[](5);
        splitTicks[0] = initialTickLower;
        splitTicks[1] = initialTickLower + (initialTickUpper - initialTickLower) / 2;
        splitTicks[2] = 200310;
        splitTicks[3] = 200320;
        splitTicks[4] = initialTickUpper;
    ...
    function testSplitPositionWithPositiveTick_TickLower_Negative_TickUpper_Positive_InRange_2() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 21000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 100 * tickSpacing;
    ...
    function testSplitPositionWithPositiveTick_TickLower_Negative_TickUpper_Positive_Token1() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 21000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 10 * tickSpacing;
        ...
        ETH.mint(address(this), 100e18);
        ETH.approve(address(pool), 100e18);
    ...
    function testSplitPositionWithPositiveTick_TickLower_Negative_TickUpper_Negative_Token1() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 22000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) - 21000 * tickSpacing;
        ...
        USDC.mint(address(this), 5000_000 * 10 ** 6);
        USDC.approve(address(pool), 5000_000 * 10 ** 6);

        pool.swap(
            address(address(this)),
            true,
            int256(5000_000 * 10 ** 6),
            TickMath.MIN_SQRT_RATIO + 1, // Swap to the lower tick
            abi.encode(address(this))
        );
    ...
    function testSplitPositionWithPositiveTick_TickLower_Negative_TickUpper_Negative_Token0() public {
        TestVars memory vars;
        ...
        USDC.mint(address(this), 5000000000_000 * 10 ** 6);
        USDC.approve(address(pool), 5000000000_000 * 10 ** 6);

        pool.swap(
            address(address(this)),
            true,
            int256(5000000000_000 * 10 ** 6),
            TickMath.MIN_SQRT_RATIO + 1, // Swap to the lower tick
            abi.encode(address(this))
        );
    ...
    function testSplitPositionWithNegativeTick_TickLower_Positive_TickUpper_Positive_Token0() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) + 22000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 23000 * tickSpacing;
    ...
    function testSplitPositionWithNegativeTick_TickLower_Negative_TickUpper_Positive_InRange() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = ((vars.currentTick / tickSpacing) * tickSpacing) - 28000 * tickSpacing;
        int24 initialTickUpper = ((vars.currentTick / tickSpacing) * tickSpacing) + 23000 * tickSpacing;
        ...
        USDC.mint(address(this), 50000000_000 * 10 ** 6);
        USDC.approve(address(pool), 50000000_000 * 10 ** 6);

        pool.swap(
            address(address(this)),
            true,
            int256(50000000_000 * 10 ** 6),
            TickMath.MIN_SQRT_RATIO + 1, // Swap to the lower tick
            abi.encode(address(this))
        );
    ...
    function testSplitPositionWithNegativeTick_TickLower_Negative_TickUpper_Negative_InRange() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = -48570;
        int24 initialTickUpper = -48170;
    ...
    function testSplitPositionWithNegativeTick_TickLower_Negative_TickUpper_Negative_Token0() public {
        TestVars memory vars;
        ...
        // Calculate tick range that spans the current tick
        int24 initialTickLower = -48970;
        int24 initialTickUpper = -48370;
